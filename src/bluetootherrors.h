...
enum BluetoothErrorCode
{
	...
	BT_ERR_MESH_CONFIG_PARAM_MISSING = 328,
	BT_ERR_MESH_RELAY_PARAM_MISSING = 329,
	BT_ERR_MESH_RETRANSMIT_COUNT_PARAM_MISSING = 330,
	BT_ERR_MESH_RETRANSMIT_INTERVAL_STEPS_PARAM_MISSING = 331
};
