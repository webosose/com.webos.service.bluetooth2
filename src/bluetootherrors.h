...
enum BluetoothErrorCode
{
	...
	BT_ERR_MESH_NET_KEY_INDEX_PARAM_MISSING = 309,
	BT_ERR_MESH_APP_KEY_INDEX_PARAM_MISSING = 310,
	...
	BT_ERR_MESH_APP_KEY_INDEX_INVALID = 321,
	BT_ERR_MESH_NODE_IDENTITY_PARAM_MISSING = 322,
	BT_ERR_MESH_RELAY_STATUS_PARAM_MISSING = 323,
	BT_ERR_MESH_NUMBER_PARAM_MISSING = 324,
	BT_ERR_MESH_OOB_DATA_PARAM_MISSING = 325,
	BT_ERR_MESH_ONOFF_PARAM_MISSING = 326,
	BT_ERR_MESH_NETWORK_NOT_CREATED= 327,
	BT_ERR_MESH_ADAPTER_NOT_AUTHORIZED = 328,
	...
	BT_ERR_MESH_KEY_REFRESH_IN_PROGRESS = 335
};
